...
uint8_t fadeDelay = 30;  // milliseconds between each fading step, 5-25 should work okay-ish
#endif
...
void dotsFader();
void serverSetup();
CRGBPalette16 stringToPalette(String colorName);
...
void paletteSwitcher() {
    ...
    File file = LittleFS.open("/currentPalette.col", "r");

    switch (currentIndex) {
        case 0:
            file.read((uint8_t*)&currentPalette, sizeof(CRGBPalette16));
            file.close();
            break;
        case 1:
...
void serverSetup() {
    ...
    // Handle button press and get slider value
    server.on("/submit", HTTP_GET, [](AsyncWebServerRequest* request) {
        File file = LittleFS.open("/currentPalette.col", "w");
        int sliderValue = request->arg("sliderValue").toInt();
        brightness = sliderValue;
        String selectedColor = request->arg("selectedColor");
        currentPalette = stringToPalette(selectedColor);
        file.write((uint8_t*)&currentPalette, sizeof(CRGBPalette16));
        file.close();
...
CRGBPalette16 stringToPalette(String colorName) {
    if (colorName == "AliceBlue") return CRGBPalette16(CRGB::AliceBlue);
    if (colorName == "Amethyst") return CRGBPalette16(CRGB::Amethyst);
    if (colorName == "AntiqueWhite") return CRGBPalette16(CRGB::AntiqueWhite);
    if (colorName == "Aqua") return CRGBPalette16(CRGB::Aqua);
    if (colorName == "Aquamarine") return CRGBPalette16(CRGB::Aquamarine);
    if (colorName == "Azure") return CRGBPalette16(CRGB::Azure);
    if (colorName == "Beige") return CRGBPalette16(CRGB::Beige);
    if (colorName == "Bisque") return CRGBPalette16(CRGB::Bisque);
    if (colorName == "Black") return CRGBPalette16(CRGB::Black);
    if (colorName == "BlanchedAlmond") return CRGBPalette16(CRGB::BlanchedAlmond);
    if (colorName == "Blue") return CRGBPalette16(CRGB::Blue);
    if (colorName == "BlueViolet") return CRGBPalette16(CRGB::BlueViolet);
    if (colorName == "Brown") return CRGBPalette16(CRGB::Brown);
    if (colorName == "BurlyWood") return CRGBPalette16(CRGB::BurlyWood);
    if (colorName == "CadetBlue") return CRGBPalette16(CRGB::CadetBlue);
    if (colorName == "Chartreuse") return CRGBPalette16(CRGB::Chartreuse);
    if (colorName == "Chocolate") return CRGBPalette16(CRGB::Chocolate);
    if (colorName == "Coral") return CRGBPalette16(CRGB::Coral);
    if (colorName == "CornflowerBlue") return CRGBPalette16(CRGB::CornflowerBlue);
    if (colorName == "Cornsilk") return CRGBPalette16(CRGB::Cornsilk);
    if (colorName == "Crimson") return CRGBPalette16(CRGB::Crimson);
    if (colorName == "Cyan") return CRGBPalette16(CRGB::Cyan);
    if (colorName == "DarkBlue") return CRGBPalette16(CRGB::DarkBlue);
    if (colorName == "DarkCyan") return CRGBPalette16(CRGB::DarkCyan);
    if (colorName == "DarkGoldenrod") return CRGBPalette16(CRGB::DarkGoldenrod);
    if (colorName == "DarkGray") return CRGBPalette16(CRGB::DarkGray);
    if (colorName == "DarkGrey") return CRGBPalette16(CRGB::DarkGrey);
    if (colorName == "DarkGreen") return CRGBPalette16(CRGB::DarkGreen);
    if (colorName == "DarkKhaki") return CRGBPalette16(CRGB::DarkKhaki);
    if (colorName == "DarkMagenta") return CRGBPalette16(CRGB::DarkMagenta);
    if (colorName == "DarkOliveGreen") return CRGBPalette16(CRGB::DarkOliveGreen);
    if (colorName == "DarkOrange") return CRGBPalette16(CRGB::DarkOrange);
    if (colorName == "DarkOrchid") return CRGBPalette16(CRGB::DarkOrchid);
    if (colorName == "DarkRed") return CRGBPalette16(CRGB::DarkRed);
    if (colorName == "DarkSalmon") return CRGBPalette16(CRGB::DarkSalmon);
    if (colorName == "DarkSeaGreen") return CRGBPalette16(CRGB::DarkSeaGreen);
    if (colorName == "DarkSlateBlue") return CRGBPalette16(CRGB::DarkSlateBlue);
    if (colorName == "DarkSlateGray") return CRGBPalette16(CRGB::DarkSlateGray);
    if (colorName == "DarkSlateGrey") return CRGBPalette16(CRGB::DarkSlateGrey);
    if (colorName == "DarkTurquoise") return CRGBPalette16(CRGB::DarkTurquoise);
    if (colorName == "DarkViolet") return CRGBPalette16(CRGB::DarkViolet);
    if (colorName == "DeepPink") return CRGBPalette16(CRGB::DeepPink);
    if (colorName == "DeepSkyBlue") return CRGBPalette16(CRGB::DeepSkyBlue);
    if (colorName == "DimGray") return CRGBPalette16(CRGB::DimGray);
    if (colorName == "DimGrey") return CRGBPalette16(CRGB::DimGrey);
    if (colorName == "DodgerBlue") return CRGBPalette16(CRGB::DodgerBlue);
    if (colorName == "FireBrick") return CRGBPalette16(CRGB::FireBrick);
    if (colorName == "FloralWhite") return CRGBPalette16(CRGB::FloralWhite);
    if (colorName == "ForestGreen") return CRGBPalette16(CRGB::ForestGreen);
    if (colorName == "Fuchsia") return CRGBPalette16(CRGB::Fuchsia);
    if (colorName == "Gainsboro") return CRGBPalette16(CRGB::Gainsboro);
    if (colorName == "GhostWhite") return CRGBPalette16(CRGB::GhostWhite);
    if (colorName == "Gold") return CRGBPalette16(CRGB::Gold);
    if (colorName == "Goldenrod") return CRGBPalette16(CRGB::Goldenrod);
    if (colorName == "Gray") return CRGBPalette16(CRGB::Gray);
    if (colorName == "Grey") return CRGBPalette16(CRGB::Grey);
    if (colorName == "Green") return CRGBPalette16(CRGB::Green);
    if (colorName == "GreenYellow") return CRGBPalette16(CRGB::GreenYellow);
    if (colorName == "Honeydew") return CRGBPalette16(CRGB::Honeydew);
    if (colorName == "HotPink") return CRGBPalette16(CRGB::HotPink);
    if (colorName == "IndianRed") return CRGBPalette16(CRGB::IndianRed);
    if (colorName == "Indigo") return CRGBPalette16(CRGB::Indigo);
    if (colorName == "Ivory") return CRGBPalette16(CRGB::Ivory);
    if (colorName == "Khaki") return CRGBPalette16(CRGB::Khaki);
    if (colorName == "Lavender") return CRGBPalette16(CRGB::Lavender);
    if (colorName == "LavenderBlush") return CRGBPalette16(CRGB::LavenderBlush);
    if (colorName == "LawnGreen") return CRGBPalette16(CRGB::LawnGreen);
    if (colorName == "LemonChiffon") return CRGBPalette16(CRGB::LemonChiffon);
    if (colorName == "LightBlue") return CRGBPalette16(CRGB::LightBlue);
    if (colorName == "LightCoral") return CRGBPalette16(CRGB::LightCoral);
    if (colorName == "LightCyan") return CRGBPalette16(CRGB::LightCyan);
    if (colorName == "LightGoldenrodYellow") return CRGBPalette16(CRGB::LightGoldenrodYellow);
    if (colorName == "LightGreen") return CRGBPalette16(CRGB::LightGreen);
    if (colorName == "LightGrey") return CRGBPalette16(CRGB::LightGrey);
    if (colorName == "LightPink") return CRGBPalette16(CRGB::LightPink);
    if (colorName == "LightSalmon") return CRGBPalette16(CRGB::LightSalmon);
    if (colorName == "LightSeaGreen") return CRGBPalette16(CRGB::LightSeaGreen);
    if (colorName == "LightSkyBlue") return CRGBPalette16(CRGB::LightSkyBlue);
    if (colorName == "LightSlateGray") return CRGBPalette16(CRGB::LightSlateGray);
    if (colorName == "LightSlateGrey") return CRGBPalette16(CRGB::LightSlateGrey);
    if (colorName == "LightSteelBlue") return CRGBPalette16(CRGB::LightSteelBlue);
    if (colorName == "LightYellow") return CRGBPalette16(CRGB::LightYellow);
    if (colorName == "Lime") return CRGBPalette16(CRGB::Lime);
    if (colorName == "LimeGreen") return CRGBPalette16(CRGB::LimeGreen);
    if (colorName == "Linen") return CRGBPalette16(CRGB::Linen);
    if (colorName == "Magenta") return CRGBPalette16(CRGB::Magenta);
    if (colorName == "Maroon") return CRGBPalette16(CRGB::Maroon);
    if (colorName == "MediumAquamarine") return CRGBPalette16(CRGB::MediumAquamarine);
    if (colorName == "MediumBlue") return CRGBPalette16(CRGB::MediumBlue);
    if (colorName == "MediumOrchid") return CRGBPalette16(CRGB::MediumOrchid);
    if (colorName == "MediumPurple") return CRGBPalette16(CRGB::MediumPurple);
    if (colorName == "MediumSeaGreen") return CRGBPalette16(CRGB::MediumSeaGreen);
    if (colorName == "MediumSlateBlue") return CRGBPalette16(CRGB::MediumSlateBlue);
    if (colorName == "MediumSpringGreen") return CRGBPalette16(CRGB::MediumSpringGreen);
    if (colorName == "MediumTurquoise") return CRGBPalette16(CRGB::MediumTurquoise);
    if (colorName == "MediumVioletRed") return CRGBPalette16(CRGB::MediumVioletRed);
    if (colorName == "MidnightBlue") return CRGBPalette16(CRGB::MidnightBlue);
    if (colorName == "MintCream") return CRGBPalette16(CRGB::MintCream);
    if (colorName == "MistyRose") return CRGBPalette16(CRGB::MistyRose);
    if (colorName == "Moccasin") return CRGBPalette16(CRGB::Moccasin);
    if (colorName == "NavajoWhite") return CRGBPalette16(CRGB::NavajoWhite);
    if (colorName == "Navy") return CRGBPalette16(CRGB::Navy);
    if (colorName == "OldLace") return CRGBPalette16(CRGB::OldLace);
    if (colorName == "Olive") return CRGBPalette16(CRGB::Olive);
    if (colorName == "OliveDrab") return CRGBPalette16(CRGB::OliveDrab);
    if (colorName == "Orange") return CRGBPalette16(CRGB::Orange);
    if (colorName == "OrangeRed") return CRGBPalette16(CRGB::OrangeRed);
    if (colorName == "Orchid") return CRGBPalette16(CRGB::Orchid);
    if (colorName == "PaleGoldenrod") return CRGBPalette16(CRGB::PaleGoldenrod);
    if (colorName == "PaleGreen") return CRGBPalette16(CRGB::PaleGreen);
    if (colorName == "PaleTurquoise") return CRGBPalette16(CRGB::PaleTurquoise);
    if (colorName == "PaleVioletRed") return CRGBPalette16(CRGB::PaleVioletRed);
    if (colorName == "PapayaWhip") return CRGBPalette16(CRGB::PapayaWhip);
    if (colorName == "PeachPuff") return CRGBPalette16(CRGB::PeachPuff);
    if (colorName == "Peru") return CRGBPalette16(CRGB::Peru);
    if (colorName == "Pink") return CRGBPalette16(CRGB::Pink);
    if (colorName == "Plaid") return CRGBPalette16(CRGB::Plaid);
    if (colorName == "Plum") return CRGBPalette16(CRGB::Plum);
    if (colorName == "PowderBlue") return CRGBPalette16(CRGB::PowderBlue);
    if (colorName == "Purple") return CRGBPalette16(CRGB::Purple);
    if (colorName == "Red") return CRGBPalette16(CRGB::Red);
    if (colorName == "RosyBrown") return CRGBPalette16(CRGB::RosyBrown);
    if (colorName == "RoyalBlue") return CRGBPalette16(CRGB::RoyalBlue);
    if (colorName == "SaddleBrown") return CRGBPalette16(CRGB::SaddleBrown);
    if (colorName == "Salmon") return CRGBPalette16(CRGB::Salmon);
    if (colorName == "SandyBrown") return CRGBPalette16(CRGB::SandyBrown);
    if (colorName == "SeaGreen") return CRGBPalette16(CRGB::SeaGreen);
    if (colorName == "Seashell") return CRGBPalette16(CRGB::Seashell);
    if (colorName == "Sienna") return CRGBPalette16(CRGB::Sienna);
    if (colorName == "Silver") return CRGBPalette16(CRGB::Silver);
    if (colorName == "SkyBlue") return CRGBPalette16(CRGB::SkyBlue);
    if (colorName == "SlateBlue") return CRGBPalette16(CRGB::SlateBlue);
    if (colorName == "SlateGray") return CRGBPalette16(CRGB::SlateGray);
    if (colorName == "SlateGrey") return CRGBPalette16(CRGB::SlateGrey);
    if (colorName == "Snow") return CRGBPalette16(CRGB::Snow);
    if (colorName == "SpringGreen") return CRGBPalette16(CRGB::SpringGreen);
    if (colorName == "SteelBlue") return CRGBPalette16(CRGB::SteelBlue);
    if (colorName == "Tan") return CRGBPalette16(CRGB::Tan);
    if (colorName == "Teal") return CRGBPalette16(CRGB::Teal);
    if (colorName == "Thistle") return CRGBPalette16(CRGB::Thistle);
    if (colorName == "Tomato") return CRGBPalette16(CRGB::Tomato);
    if (colorName == "Turquoise") return CRGBPalette16(CRGB::Turquoise);
    if (colorName == "Violet") return CRGBPalette16(CRGB::Violet);
    if (colorName == "Wheat") return CRGBPalette16(CRGB::Wheat);
    if (colorName == "White") return CRGBPalette16(CRGB::White);
    if (colorName == "WhiteSmoke") return CRGBPalette16(CRGB::WhiteSmoke);
    if (colorName == "Yellow") return CRGBPalette16(CRGB::Yellow);
    if (colorName == "YellowGreen") return CRGBPalette16(CRGB::YellowGreen);
